    ...
    <div style={{ background: '#141414', border: '1px solid rgba(201,169,110,0.08)', padding: '1.5rem', marginBottom: '2rem' }}>
      ...
      {options.map(opt => (
        <div key={opt.name} style={{ marginBottom: '1.5rem' }}>
          <div style={{ color: '#6a6058', fontSize: '0.7rem', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '0.75rem' }}>{opt.name}</div>
      ...
      <div style={{ borderTop: '1px solid rgba(201,169,110,0.08)', paddingTop: '1rem', marginTop: '1rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <span style={{ color: '#6a6058', fontSize: '0.75rem', letterSpacing: '0.1em', textTransform: 'uppercase' }}>Итоговая стоимость</span>
