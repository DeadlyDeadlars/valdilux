  ...
  return (
    <div style={{ paddingTop: '5rem', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ width: '100%', maxWidth: '26rem', padding: '1.5rem' }}>
        ...
        <h1 className="serif" style={{ color: '#f0ebe3', fontSize: '2rem', fontWeight: 300, textAlign: 'center', marginBottom: '2rem' }}>
          {mode === 'login' ? 'Вход' : 'Регистрация'}
        </h1>

        <div style={{ display: 'flex', marginBottom: '2rem', borderBottom: '1px solid rgba(201,169,110,0.08)' }}>
        ...
        <p style={{ textAlign: 'center', marginTop: '1.5rem', color: '#4a4540', fontSize: '0.7rem' }}>
          <Link href="/" style={{ color: '#6a6058', textDecoration: 'none' }}>← На главную</Link>
        </p>
      </div>
    </div>
  );
