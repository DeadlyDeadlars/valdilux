    ...
    <div style={{ paddingTop: '5rem', minHeight: '100vh' }}>
      <div style={{ background: '#0a0a0a', borderBottom: '1px solid rgba(201,169,110,0.08)', padding: '5rem 1.5rem 4rem' }}>
        <div style={{ maxWidth: "48rem", margin: "0 auto", textAlign: "center" }}>
          ...
          <h1 className="serif" style={{ color: '#f0ebe3', fontSize: 'clamp(2.5rem, 5vw, 4rem)', fontWeight: 300 }}>Контакты</h1>
          <p style={{ color: '#6a6058', fontSize: '0.85rem', marginTop: '1rem' }}>Свяжитесь с нами удобным способом</p>
        </div>
      </div>
      ...
      <div style={{ maxWidth: "64rem", margin: "0 auto", padding: "4rem 1.5rem" }} className="grid grid-cols-1 md:grid-cols-2 gap-16">
        ...
        <div>
          {[
            {
              ...
              content: (
                <>
                  <a href="tel:+79058052465" style={{ display: 'block', color: '#c8bfb0', fontSize: '0.9rem', textDecoration: 'none', marginBottom: '0.4rem' }}>+7 (905) 805-24-65</a>
                  <a href="tel:+74952862926" style={{ display: 'block', color: '#c8bfb0', fontSize: '0.9rem', textDecoration: 'none', marginBottom: '0.4rem' }}>+7 (495) 286-29-26</a>
                  <p style={{ color: '#4a4540', fontSize: '0.7rem', marginTop: '0.5rem' }}>Готовы ответить на любой вопрос</p>
                </>
              ),
            },
            {
              ...
              content: (
                <>
                  <a href="mailto:valdilux-mebel@yandex.ru" style={{ color: '#c8bfb0', fontSize: '0.9rem', textDecoration: 'none' }}>valdilux-mebel@yandex.ru</a>
                  <p style={{ color: '#4a4540', fontSize: '0.7rem', marginTop: '0.5rem' }}>Ответим в течение часа</p>
                </>
              ),
            },
            {
              ...
              content: (
                <>
                  <p style={{ color: '#c8bfb0', fontSize: '0.85rem', lineHeight: 1.7 }}>Свердловская обл., г. Екатеринбург,<br />пос. Октябрьский, ул. Свердлова, 18</p>
                  <p style={{ color: '#4a4540', fontSize: '0.7rem', marginTop: '0.5rem' }}>Возможен визит по предварительной записи</p>
                </>
              ),
            },
            {
          ...
          <div style={{ background: '#141414', border: '1px solid rgba(201,169,110,0.08)', padding: '1.5rem' }}>
            <div className="section-label mb-3">Реквизиты</div>
            <p style={{ color: '#6a6058', fontSize: '0.75rem', lineHeight: 1.8 }}>
        ...
        {/* Form */}
        <div>
          <h2 className="serif" style={{ color: '#f0ebe3', fontSize: '1.5rem', fontWeight: 300, marginBottom: '2rem' }}>Задать вопрос</h2>
          {status === 'ok' ? (
            <div style={{ background: '#141414', border: '1px solid rgba(201,169,110,0.2)', padding: '2rem', textAlign: 'center' }}>
              <div style={{ color: '#c9a96e', fontSize: '0.65rem', letterSpacing: '0.15em', textTransform: 'uppercase', marginBottom: '0.5rem' }}>Отправлено</div>
              <p style={{ color: '#6a6058', fontSize: '0.8rem' }}>Мы свяжемся с вами в ближайшее время</p>
            </div>
          ) : (
